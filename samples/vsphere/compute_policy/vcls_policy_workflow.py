...
from com.vmware.vcenter.compute.policies.capabilities.vm.placement.anti_affinity_with_vcls_client \
     import CreateSpec
...
class ComputePolicyWorkflow(object):
    ...
    vCLS VM anti-affinity capability and checks the compliance status of the policy
