...
class BulkExtractSvc:
    """
    Demonstrates triggering the "extract" workflow for a group of clusters or standalone hosts
    ...
    def run(self):
        ...
        # Create a spec for extract task
