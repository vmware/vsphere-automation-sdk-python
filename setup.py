...
setup(name='vSphere Automation SDK',
      ...
      install_requires=[
        ...
        'vmc-client-bindings @ file://localhost/{}/lib/vmc-client-bindings/vmc_client_bindings-1.26.0-py2.py3-none-any.whl'.format(os.getcwd()),
        ...
        'vmc-draas-client-bindings @ file://localhost/{}/lib/vmc-draas-client-bindings/vmc_draas_client_bindings-1.10.0-py2.py3-none-any.whl'.format(os.getcwd()),
      ]
      )
