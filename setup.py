...
setup(name='vSphere Automation SDK',
      ...
      install_requires=[
        ...
        'vapi-runtime @ file://localhost/{}/lib/vapi-runtime/vapi_runtime-2.34.0-py2.py3-none-any.whl'.format(os.getcwd()),
	      'vapi-client-bindings @ file://localhost/{}/lib/vapi-client-bindings/vapi_client_bindings-3.8.0-py2.py3-none-any.whl'.format(os.getcwd()),
	      'vapi-common-client @ file://localhost/{}/lib/vapi-common-client/vapi_common_client-2.34.0-py2.py3-none-any.whl'.format(os.getcwd()),
        'vmc-client-bindings @ file://localhost/{}/lib/vmc-client-bindings/vmc_client_bindings-1.59.0-py2.py3-none-any.whl'.format(os.getcwd()),
        'nsx-python-sdk @ file://localhost/{}/lib/nsx-python-sdk/nsx_python_sdk-3.1.5.0.0-py2.py3-none-any.whl'.format(os.getcwd()),
