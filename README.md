...
```
Where  <SDK_DIRECTORY_PATH> is one of the following
1. Either install directory of the SDK 
  e.g 
  ```cmd
   pip install -U vsphere-automation-sdk-python-8.0.0.0.zip
  ```
  
2. Or from the location of the [zip](https://github.com/vmware/vsphere-automation-sdk-python/releases)
 e.g
  ```cmd
   pip install -U https://github.com/vmware/vsphere-automation-sdk-python/archive/refs/tags/v8.0.2.0.zip
  ```
